...
#constants for export files and path
PATH_WIKI_XML = '/Users/brendontoyama/xml_test'
FILENAME_WIKI = 'enwiktionary-20220801-pages-meta-current.xml'
FILENAME_ARTICLES = 'info.csv'
FILENAME_REDIRECT = 'info_redirect.csv'
FILENAME_TEMPLATE = 'info_template.csv'
ENCODING = "utf-8"
